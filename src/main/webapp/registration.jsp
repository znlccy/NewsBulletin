...
<head>
<title>上海理工大学电子商务发展研究院-注册页面</title>
        	...
        	<div class="inner">
            	<div class="general_content">
                	<div class="main_content">
                        ...
                        <p class="general_title"><span>注册信息填写</span></p>
                        <div class="separator" style="height:39px;"></div>
                        
                        <div class="block_registration" style="border: 1px red">
                        		
                            	<div class="col_1" >
                            	<form id="registeredForm" action="http://localhost:8080/NewsBulletin/user/registered" method="post">
                                    ...
                                    <div class="field"><input type="text" name="nickname" class="req" /></div>
                                    <div class="clearboth"></div>
                                    <div class="separator" style="height:14px;"></div>
                            	
                                	<div class="label"><p>手机<span>*</span>:</p></div>
                                    <div class="field"><input type="text" name="mobile" class="req" /></div>
                                    <div class="clearboth"></div>
                                    <div class="separator" style="height:14px;"></div>
                                    ...
                                    <div class="label"><p>QQ:</p></div>
                                    <div class="field"><input type="text" name="QQ" /></div>
                                    <div class="clearboth"></div>
                                    <div class="separator" style="height:14px;"></div>
                                    
                                    <div class="label"><p>微信:</p></div>
                                    <div class="field"><input type="text" name="WeiXin" /></div>
                                    <div class="clearboth"></div>
                                    <div class="separator" style="height:14px;"></div>
                                    
                                    <div class="label"><p>新浪:</p></div>
                                    <div class="field"><input type="text" name="XinLang" /></div>
                                    <div class="clearboth"></div>
                                    <div class="separator" style="height:14px;"></div>
                                    
                                    <div class="label"><p>用户头像:</p></div>
                                    <div style="width:261px;height:27px;float:right;overflow:hidden;position:relative;background-color:#ffffff;-moz-border-radius:2px;-webkit-border-radius:2px;border-radius:2px;"><input type="file" name="userPicture"/></div>
                                    <div class="clearboth"></div>
                                    <div class="separator" style="height:14px;"></div>
                                    
                                    <div class="label"><p>性别:</p></div>
                                    <div class="checkbox"><input class="sliding_checkbox" type="checkbox" name="gender" /></div>
                                    <script type="text/javascript">
                                ...
                                <p class="info_text">您已经同意用户注册协议，请通过点击"注册"按钮进行注册 (<a href="confidentiality_agreement.jsp">用户注册协议</a>)</p>
                                <p class="info_text"><button id="submit" type="submit" class="general_button" style="border: none;">注册用户</button></p>
                                </form>
                        </div>
