...
<head>
<title>上海理工大学电子商务发展研究院-电商法律</title>
            	...
            	<div class="general_content">
                	<div class="main_content">
                        ...
                        <div class="block_testimonial_type_1">
                        	<div class="text">
                            	<div class="tail"></div>
                                <p id="title">Randomised words which don't look even slightly believable. If you are going to use a passage. You need to be sure there isn't anything embarrassing hidden in the middle of text.</p>
                            </div>
                        ...
                        <div class="block_testimonial_type_2">
                        	<div class="text">
                                <p>Words which don't look even slightly believable. If you are going to use a passage. You need to be sure there isn't anything embarrassing established fact that a reader.</p>
                            </div>
                    ...
                    <div class="sidebar">
                    	<div class="block_subscribes_sidebar">
                        	<div class="service">
                            	<a href="#" class="qqzone" onclick="shareWeixin()">
                            ...
                            <div class="service">
                            	<a href="#" class="qq" onclick="shareQQ()">
