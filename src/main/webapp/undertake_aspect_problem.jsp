...
<head>
<title>上海理工大学电子商务发展研究院-承接纵横问题</title>
            	...
            	<div class="general_content">
                	<div class="main_content">
                        ...
                        <div class="block_post_tags">
                        	<p>分类: <a href="#">business,</a><a href="#">stock market</a></p>
                        </div>
                        ...
                        <div class="block_post_social">
                            ...
                            <section class="rating">
                            	<p class="title"><span>统计</span></p>
                                
                                <ul>
                                	<li><span>1024</span>浏览过</li>
                                    <li><span>4</span>留言</li>
                                </ul>
                            </section>
                        ...
                        <div class="block_leave_reply">
                        	<h3>回复留言</h3>
                        	<p class="text">您的邮箱地址不会被公布. 需要您填写下面必内容 <span>*</span></p>
                        	...
                        	<form class="w_validation" action="#" />
                                ...
                                <input type="submit" class="general_button" value="提交留言" />
                            </form>
                        </div>
