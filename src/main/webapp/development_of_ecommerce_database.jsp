...
<head>
<title>上海理工大学电子商务发展研究院-电子商务发展数据库</title>
...
<script type="text/javascript">
	...
	function getDedNews(){
		...
		$.ajax({
			type:"GET",
			url:"http://localhost:8080/NewsBulletin/eddc/getdednews",
			data:data,
			dataType:'json',
			success:function(map){
				var status = JSON.stringify(map.status);
				...
				if(status==status_success){
					document.getElementById("newstitle").innerHTML=JSON.stringify(map.newstitle).replace(/\"/g, "");
					document.getElementById("newsdate").innerHTML=JSON.stringify(map.newsdate).replace(/\"/g, "");
					document.getElementById("newscontent").innerHTML=JSON.stringify(map.newscontent).replace(/\"/g, "");
					document.getElementById("author").innerHTML=JSON.stringify(map.author).replace(/\"/g, "");
				} 
			}
		});
	}
                    	...
                    	<nav class="main_menu">
                        	<ul>
								<li class="big_dropdown"><a href="index.jsp">首页</a>
							  	...
							  	<li class="current_page_item" data-content="technology"><a href="development_of_ecommerce_database.jsp">电子商务发展数据库</a></li>
            	...
            	<div class="general_content">
                	<div class="main_content">
                    	<div class="block_breadcrumbs">
                            ...
                            <ul>
                            	<li><a href="development_of_ecommerce_database.jsp">电子商务发展数据库</a></li>
                                <!-- <li>电子商务发展数据库</li> -->
                            </ul>
                        </div>
                        ...
                        <p class="general_subtitle">电子商务发展数据库是关于电子商务和数据库结合的技术</p>
                        
                        <div class="line_4" style="margin:0px 0px 18px;"></div>
                        
                        <article class="block_single_post">
                        	<div class="f_pic"><a href="#"><img src="images/pic_blog_post_1.jpg" onload="getDedNews()" alt="" /></a></div>
                          <p class="title"><a href="#" id="newstitle">电子商务发展数据库展示</a></p>
                            <p class="subtitle">电子商务发展数据库的相关资讯</p>
                            
                            <div class="info">
                                <div class="date" ><p id="newsdate">没有创建时间</p></div>
                                <div class="author"><p>作者: <a href="#" id="author">没有作者</a></p></div>
                                    
                            	<div class="r_part">
                                	<div class="category"><p>分类: <a href="#">科研成果</a></p></div>
                            ...
                            <!-- <div class="about_author">
                            	...
                            	<div class="photo"><a href="#"><img src="images/ava_default_3.jpg" alt="" /></a></div>
                                <div class="bio">
                                	<p class="name"><a href="#" id="authortwo">没有作者</a></p>
                                    <p id="authorprofile">没有作者简介</p>
                                </div>
