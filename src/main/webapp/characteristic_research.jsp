...
<head>
<title>上海理工大学电子商务发展研究院-特色研究</title>
                    	...
                    	<nav class="main_menu">
                        	<ul>
								<li class="big_dropdown"><a href="index.jsp">首页</a>
							  	...
							  	<li class="current_page_item"><a href="characteristic_research.jsp">特色研究</a>
                                    <ul>
            	...
            	<div class="general_content">
                	<div class="main_content">
                    	<div class="block_breadcrumbs">
                            ...
                            <ul>
                            	<li><a href="characteristic_research.jsp">特色研究</a></li>
                        ...
                        <article class="block_single_post">
                          ...
                          <p class="title"><a href="#" id="newstitle">特色研究展示</a></p>
                            <p class="subtitle">特色研究的相关资讯</p>
                            ...
                            <div class="info">
                            	...
                            	<div class="r_part">
                                	<div class="category"><p>分类: <a href="#">特色研究</a></p></div>
                            ...
                            <div class="about_author">
                                ...
                                <div class="bio">
                                	<p class="name"><a href="#">Roman Polyarush</a></p>
                                    <p>Fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution.</p>
                                </div>
