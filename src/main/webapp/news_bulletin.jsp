...
<head>
<title>上海理工大学电子商务发展研究院-学院要闻</title>
                    	...
                    	<nav class="main_menu">
                        	<ul>
								<li class="big_dropdown"><a href="index.jsp">首页</a>
							  	...
							  	<li class="current_page_item" data-content="technology"><a href="news_bulletin.jsp">新闻公告</a></li>
            	...
            	<div class="general_content">
                	<div class="main_content">
                    	<div class="block_breadcrumbs">
                            ...
                            <ul>
                            	<li><a href="news_bulletin.jsp">新闻公告</a></li>
                                <!-- <li>新闻公告</li> -->
                            </ul>
                        </div>
                        ...
                        <!-- <h5>Accordion style 1</h5>
                        
                        <div class="block_accordeon_type_1">
                            <div class="button_outer first"><div class="button_inner">Publishing packages and web page.</div></div>accordeon trigger
                            <div class="accordeon_content">
                                accordeon content goes here
                                <p>Many variations of passages of available, but the majority have suffered alteration in some form. Humour, or randomised words which don't look even slightly believable. If you are going to use a passage of you need to be sure.</p>
                            </div>
                            
                            <div class="button_outer"><div class="button_inner">Variations of passages of available.</div></div>accordeon trigger
                            <div class="accordeon_content">
                                accordeon content goes here
                                <p>Many variations of passages of available, but the majority have suffered alteration in some form. Humour, or randomised words which don't look even slightly believable. If you are going to use a passage of you need to be sure.</p>
                            </div>
                            
                            <div class="button_outer"><div class="button_inner">Majority have suffered alteration in some form.</div></div>accordeon trigger
                            <div class="accordeon_content">
                                accordeon content goes here
                                <p>Many variations of passages of available, but the majority have suffered alteration in some form. Humour, or randomised words which don't look even slightly believable. If you are going to use a passage of you need to be sure.</p>
                            </div>
                            
                            <div class="button_outer"><div class="button_inner">Alteration in some form by injected humour.</div></div>accordeon trigger
                            <div class="accordeon_content">
                                accordeon content goes here
                                <p>Many variations of passages of available, but the majority have suffered alteration in some form. Humour, or randomised words which don't look even slightly believable. If you are going to use a passage of you need to be sure.</p>
                            </div>
                        ...
                        <h5>Accordion style 2</h5>
                        
                        <div class="block_accordeon_type_2">
                            <div class="button_outer first"><div class="button_inner">Desktop publishing packages and web page editors now use.</div><div class="arrow"></div></div>accordeon trigger
                            <div class="accordeon_content">
                                accordeon content goes here
                                <p>Many variations of passages of available, but the majority have suffered alteration in some form. Humour, or randomised words which don't look even slightly believable. If you are going to use a passage of you need to be sure there isn't anything embarrassing hidden.</p>
                            </div>
                            
                            <div class="button_outer"><div class="button_inner">Web page editors now use their default model text, and a search.</div><div class="arrow"></div></div>accordeon trigger
                            <div class="accordeon_content">
                                accordeon content goes here
                                <p>Many variations of passages of available, but the majority have suffered alteration in some form. Humour, or randomised words which don't look even slightly believable. If you are going to use a passage of you need to be sure there isn't anything embarrassing hidden.</p>
                            </div>
                            
                            <div class="button_outer"><div class="button_inner">Established fact that a reader will be distracted.</div><div class="arrow"></div></div>accordeon trigger
                            <div class="accordeon_content">
                                accordeon content goes here
                                <p>Many variations of passages of available, but the majority have suffered alteration in some form. Humour, or randomised words which don't look even slightly believable. If you are going to use a passage of you need to be sure there isn't anything embarrassing hidden.</p>
                            </div>
                        ...
                        <div class="line_2" style="margin:22px 0px 0px;"></div> -->
                       	...
                       	<form action="">
                        <h5 id="newsTitleOne">测试新闻1</h5>
                        
                        <div class="block_testimonial_type_1">
                        	<div class="text">
                            	<div class="tail"></div>
                                <p id="newsContentOne" >测试新闻内容-电子商务发展历史以及发展趋势，对未来会产生什么影响</p>
                            </div>
                            
                            <div class="author"><p><a href="#">张三</a>. <a href="#" class="position">设计师</a></p></div>
                        </div>
                        
                        <div class="line_2" style="margin:25px 0px 25px;"></div>
                        
                        <h5 id="newsTitleTwo">测试新闻2</h5>
                        
                        <div class="block_testimonial_type_1">
                        	<div class="text">
                            	<div class="tail"></div>
                                <p id="newsContentTwo">测试新闻内容-电子商务发展历史以及发展趋势，对未来会产生什么影响</p>
                            </div>
                            
                            <div class="author"><p><a href="#">李四</a>. <a href="#" class="position">设计师</a></p></div>
                        </div>
                        
                        <div class="line_2" style="margin:25px 0px 25px;"></div>
                        
                        <h5 id="newsTitleThree">测试新闻3</h5>
                        
                        <div class="block_testimonial_type_1">
                        	<div class="text">
                            	<div class="tail"></div>
                                <p id="newsContenThree">测试新闻内容-电子商务发展历史以及发展趋势，对未来会产生什么影响</p>
                            </div>
                            
                            <div class="author"><p><a href="#">朱熹</a>. <a href="#" class="position">设计师</a></p></div>
                        </div>
                        
                        <div class="line_2" style="margin:25px 0px 25px;"></div>
                        
                        <h5 id="newsTitleFour">测试新闻4</h5>
                        
                        <div class="block_testimonial_type_1">
                        	<div class="text">
                            	<div class="tail"></div>
                                <p id="newsContentFour">测试新闻内容-电子商务发展历史以及发展趋势，对未来会产生什么影响</p>
                            </div>
                            
                            <div class="author"><p><a href="#">黄家驹</a>. <a href="#" class="position">设计师</a></p></div>
                        </div>
                        
                        <div class="line_2" style="margin:25px 0px 25px;"></div>
                        
                        <div class="block_pager">
                        	<a href="#" class="prev" id="">前一页</a>
                            <a href="#" class="next" id="">后一页</a>
