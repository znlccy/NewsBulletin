            	...
            	<div class="general_content">
                	<div class="main_content">
                        ...
                        <div class="line_2" style="margin:22px 0px 0px;"></div> -->
                       	...
                       	<form action="">
                        <h5 id="newsfour">没有新闻</h5>
                        
                        <div class="block_testimonial_type_1">
                        	<div class="text">
                            	<div class="tail"></div>
                                <p id="newsfourcontent" >没有新闻内容</p>
                            </div>
                            
                            <div class="author"><p><a href="#" id="newsfourcontent">没有作者</a></p></div>
                        </div>
                        
                        <div class="line_2" style="margin:25px 0px 25px;"></div>
                        
                        <h5 id="newsfive">没有新闻</h5>
                        
                        <div class="block_testimonial_type_1">
                        	<div class="text">
                            	<div class="tail"></div>
                                <p id="newsfivecontent">没有新闻内容</p>
                            </div>
                            
                            <div class="author"><p><a href="#" id="author">没有作者</a></p></div>
                        </div>
                        
                        <div class="line_2" style="margin:25px 0px 25px;"></div>
                        
                        <h5 id="newssix">没有新闻</h5>
                        
                        <div class="block_testimonial_type_1">
                        	<div class="text">
                            	<div class="tail"></div>
                                <p id="newssixcontent">没有新闻内容</p>
                            </div>
                            
                            <div class="author"><p><a href="#" id="newssixauthor">没有作者</a></p></div>
                        </div>
                        
                        <div class="line_2" style="margin:25px 0px 25px;"></div>
                        
                        <h5 id="newsseven">没有新闻</h5>
                        
                        <div class="block_testimonial_type_1">
                        	<div class="text">
                            	<div class="tail"></div>
                                <p id="newssevencontent">没有新闻内容</p>
                            </div>
                            
                            <div class="author"><p><a href="#">没有作者</a></p></div>
                        </div>
