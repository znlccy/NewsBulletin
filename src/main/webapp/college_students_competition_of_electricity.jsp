...
<head>
<title>上海理工大学电子商务发展研究院-电商竞赛</title>
            	...
            	<div class="general_content">
                	<div class="main_content">
                        ...
                        <article class="block_topic_post_feature">
                        	<div class="f_pic"><a href="#" class="general_pic_hover scale"><img src="images/pic_education_big.jpg" alt="" /></a></div>
                            
                            <div class="content">
                            	<p class="title"><a href="#">Publishing packages and web page editors now use.</a></p>
                                
                                <div class="info">
                                	<div class="date"><p>11 July, 2012</p></div>
                                    
                                    <div class="r_part">
                                    	<div class="category"><p><a href="#">视频</a></p></div>
                        ...
                        <div class="block_topic_news">
                        	<article class="block_topic_post">
                            	<p class="title"><a href="#">Many desktop publishing packages and web page editors now use.</a></p>
                                <div class="f_pic"><a href="#" class="general_pic_hover scale"><img src="images/pic_education_1.jpg" alt="" /></a></div>
                                <p class="text">There are many variations of passages of available, but the majority have alteration.</p>
                                <div class="info">
                                	<div class="date"><p>11 July, 2017</p></div>
                            ...
                            <article class="block_topic_post">
                            	<p class="title"><a href="#">Many desktop publishing packages and web page editors now use.</a></p>
                                <div class="f_pic"><a href="#" class="general_pic_hover scale"><img src="images/pic_education_2.jpg" alt="" /></a></div>
                                <p class="text">There are many variations of passages of available, but the majority have alteration.</p>
                                <div class="info">
                                	<div class="date"><p>11 July, 2017</p></div>
                            ...
                            <article class="block_topic_post">
                            	<p class="title"><a href="#">Many desktop publishing packages and web page editors now use.</a></p>
                                <div class="f_pic"><a href="#" class="general_pic_hover scale"><img src="images/pic_education_3.jpg" alt="" /></a></div>
                                <p class="text">There are many variations of passages of available, but the majority have alteration.</p>
                                <div class="info">
                                	<div class="date"><p>11 July, 2017</p></div>
                            ...
                            <article class="block_topic_post">
                            	<p class="title"><a href="#">Many desktop publishing packages and web page editors now use.</a></p>
                                <div class="f_pic"><a href="#" class="general_pic_hover scale"><img src="images/pic_education_4.jpg" alt="" /></a></div>
                                <p class="text">There are many variations of passages of available, but the majority have alteration.</p>
                                <div class="info">
                                	<div class="date"><p>11 July, 2017</p></div>
                            ...
                            <article class="block_topic_post">
                            	<p class="title"><a href="#">Many desktop publishing packages and web page editors now use.</a></p>
                                <div class="f_pic"><a href="#" class="general_pic_hover scale"><img src="images/pic_education_5.jpg" alt="" /></a></div>
                                <p class="text">There are many variations of passages of available, but the majority have alteration.</p>
                                <div class="info">
                                	<div class="date"><p>11 July, 2017</p></div>
                            ...
                            <article class="block_topic_post">
                            	<p class="title"><a href="#">Many desktop publishing packages and web page editors now use.</a></p>
                                <div class="f_pic"><a href="#" class="general_pic_hover scale"><img src="images/pic_education_6.jpg" alt="" /></a></div>
                                <p class="text">There are many variations of passages of available, but the majority have alteration.</p>
                                <div class="info">
                                	<div class="date"><p>11 July, 2017</p></div>
                            ...
                            <article class="block_topic_post">
                            	<p class="title"><a href="#">Many desktop publishing packages and web page editors now use.</a></p>
                                <div class="f_pic"><a href="#" class="general_pic_hover scale"><img src="images/pic_education_7.jpg" alt="" /></a></div>
                                <p class="text">There are many variations of passages of available, but the majority have alteration.</p>
                                <div class="info">
                                	<div class="date"><p>11 July, 2017</p></div>
                            ...
                            <article class="block_topic_post">
                            	<p class="title"><a href="#">Many desktop publishing packages and web page editors now use.</a></p>
                                <div class="f_pic"><a href="#" class="general_pic_hover scale"><img src="images/pic_education_8.jpg" alt="" /></a></div>
                                <p class="text">There are many variations of passages of available, but the majority have alteration.</p>
                                <div class="info">
                                	<div class="date"><p>11 July, 2017</p></div>
