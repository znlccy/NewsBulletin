...
<head>
<title>上海理工大学电子商务发展研究院-学院公告</title>
                    	...
                    	<nav class="main_menu">
                        	<ul>
								<li class="big_dropdown"><a href="index.jsp">首页</a>
							  	...
							  	<li class="current_page_item" data-content="education">
            	...
            	<div class="general_content">
                	<div class="main_content">
                    	<div class="block_breadcrumbs">
                            ...
                            <ul>
                            	<li><a href="characteristic_research.jsp">科研成果</a></li>
                        ...
                        <div class="separator" style="height:30px;"></div>
                         ...
                         <article class="block_single_post">
                          ...
                          <p class="title"><a href="#" id="newstitle">科研成果展示</a></p>
                            <p class="subtitle">科技成果的相关资讯</p>
